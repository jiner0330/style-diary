...
const SUBCAT_ENUMS: Record<string, string[]> = {
  ...
  outerwear: ["blazer", "jacket", "trench", "bomber", "cardigan", "shirt_jacket"],
  shoes: ["sneakers", "heels", "boots", "loafers", "sandals", "flats", "mary_jane"],
  bag: ["tote", "shoulder", "crossbody", "armpit", "backpack"],
